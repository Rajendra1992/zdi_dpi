...
st.markdown(
    ...
    /* Custom CSS for larger dataframe */
    .classification-dataframe {
        width: 100% !important;
        height: 600px !important;
    }
    
    /* Make the data editor container full width and height */
    ...
    if app_mode_classification == "Home":
        ...
        def auto_save_classification_report(df, database, schema):
            ...
            try:
                ...
                st.session_state.save_status = f"❌ Save failed: {str(e)}"
                return False
        ...
        # UI for classification report editing with full screen layout
        ...
        # Editable DataFrame with full screen layout
        if st.session_state.report_fetched and st.session_state.edited_df is not None:
            ...
            # Create a container for the data editor with custom styling
            with st.container():
            ...
            # Check if data has been edited and auto-save
            if not edited_df.equals(st.session_state.edited_df):
                ...
                st.rerun()  # Refresh to show save status
